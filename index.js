...
require('dotenv').config();//so i can access .env

const app = express()//create variable that calls express() function
const port = process.env.PORT || 5000 //set our set our process env

let db_url = process.env.CONNECTION_STRING
//connectstring is in .env file
